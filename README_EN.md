# 🎮 Game News & Trailers Bot — Documentation (EN)
...
Full details: [docs/SECURITY_GRC_ANALYSIS.md](docs/SECURITY_GRC_ANALYSIS.md)
...
Full reference: [docs/COMMANDS_REFERENCE.md](docs/COMMANDS_REFERENCE.md)
...
- **systemd:** See [docs/DEPLOY.md](docs/DEPLOY.md) for Linux service setup.
...
**Game News & Trailers Bot** — Game news and trailers in your Discord.
